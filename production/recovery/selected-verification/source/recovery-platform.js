...
const outline=[[-4.25,-4.4],[-3.7,-5],[3.7,-5],[4.25,-4.4],[4.25,4.4],[3.7,5],[-3.7,5],[-4.25,4.4]];slab(outline,.18,1.85,dark);slab(outline.map(([x,z])=>[x*1.012,z*1.012]),.08,1.72,bronze);slab(outline.map(([x,z])=>[x*1.02,z*1.02]),.22,1.47,stone);
