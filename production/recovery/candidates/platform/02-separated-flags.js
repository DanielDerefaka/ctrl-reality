...
for(let j=0;j<5;j++)for(let i=0;i<4;i++){const x=-4.2+i*2.1,z=-5+j*2;slab([[x+.025,z+.025],[x+2.07,z+.025],[x+2.07,z+1.97],[x+.025,z+1.97]],.2,1.83,(i+j)%3?dark:stone);}slab([[-4.27,-5.05],[4.27,-5.05],[4.27,5.05],[-4.27,5.05]],.18,1.59,stone);
